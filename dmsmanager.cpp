...
tcpComponent(tcpPort, drowsinessDetectionQueue,commandsQueue,faultsQueue),
...
cameraQueue(cameraQueue),preprocessingQueue(preprocessingQueue), faceDetectionQueue(faceDetectionQueue), drowsinessDetectionQueue(drowsinessDetectionQueue), tcpPort(tcpPort),stateOutputQueue(stateOutputQueue),postOutputQueue(postOutputQueue),
